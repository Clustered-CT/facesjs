  ...
  toXml() {
    ...
    if (this.tag) {
      ...
      for (const attributeName of Object.keys(this.attributes)) {
        const attributeValue = this.attributes[attributeName].replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
 ...
 */
export const faceToSvgString = (face, overrides) => {
  ...
  try {
    ...
    display(svgDocument, face, overrides);
  } finally {
